...
@dag(default_args=default_args, schedule_interval='0 * * * *', tags=['cumulus', 'historic', 'airtemp', 'develop'])
def develop_cumulus_historic_ndgd_ltia98():
...
ltia98_dag = develop_cumulus_historic_ndgd_ltia98()