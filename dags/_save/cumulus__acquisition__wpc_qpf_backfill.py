...
default_args = {
    ...
    "start_date": (datetime.utcnow() - timedelta(days=6)).replace(
...
@dag(
    ...
    schedule="0 00,06,12,18 * * *",
    tags=["cumulus", "forecast", "backfill"],
)
    ...
    def download_raw_data():
        ...
        for hour in fcst_hrs[forecast_hour]:
            ...
            output = trigger_download(
                ...
                s3_key=f"cumulus/acquirables/wpc_{PROD_SOURCE_DIR}/{filename}",
            )
