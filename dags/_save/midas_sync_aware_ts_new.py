...
with DAG(
    ...
    for pg_id, pg_list in enumerate(processing_groups):
        ...
        with TaskGroup(group_id=tg_id) as tg:
            ...
            for i in pg_list:
                ...
                fetch_task_id = f"task_{str(i).zfill(3)}_fetch_{instruments[i]['instrument_id']}"        
    ...
    get_midas_configs_task >> flashflood_authenticate_task >> task_groups[0] >> task_groups[1]