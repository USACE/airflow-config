...
with DAG(
    ...
    tags=['cumulus', 'forecast', 'precip', 'airtemp', 'develop'],    
    ...
    def check_new_forecast(status_s3_key, src_status_filepath, src_filename):
        ...
        if s3_status_contents:            
            s3_forecast_datetime = get_product_datetime_from_dir_listing(s3_status_contents, src_filename)
        ...
        if src_status_contents:
            src_file_datetime = get_product_datetime_from_dir_listing(src_status_contents, src_filename)
