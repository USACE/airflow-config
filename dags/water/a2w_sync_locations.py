"""
This dag needs to be refactored to only call the office API inside a task or sensor.

This method of calling an API outside the task will fail when running on any system that 
does not have proper API access (ex: Github Actions)
"""
